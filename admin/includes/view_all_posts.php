    ...
    foreach($_POST['checkBoxArray'] as $checkBoxValue){
        ...
        switch($bulk_options){
            ...
            case 'clone':
                ...
                $copy_result = mysqli_query($connection,$query);
                if(!$copy_result){
...
<form action="" method="post">
   <table class="table table-bordered table-hover">
       ...
       <div class="col-xs-4">
        ...
        <?php 
            $user = currentUser();
            //Treba dopustiti da moze pregledati samo svoje ili sve postove
...
//                }
                ...
                $query11 = "SELECT * FROM comments WHERE comment_post_id = $post_id";
                $result11 = mysqli_query($connection,$query11);
                $row = mysqli_fetch_array($result11);
                $comment_id = $row['comment_id'];
                $count_comments = mysqli_num_rows($result11);
